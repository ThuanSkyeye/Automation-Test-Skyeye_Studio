...
class Test:
    ...
    def test_login(self):
        ...
        project_element = self.driver.find_element(By.XPATH, project_xpath)
        ...
        button_element = WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable((By.XPATH, button_xpath)))
